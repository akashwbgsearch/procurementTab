...
@Component({
  ...
  templateUrl: './app.basecomponent.html'    
})
export class BaseComponent {
	...
	ngOnInit(){
		...
		this.domain = this.element.nativeElement.getAttribute('domain');
		...
		this.noticesApiUrl=this.element.nativeElement.getAttribute('noticesApiUrl');
		this.contractsApiUrl=this.element.nativeElement.getAttribute('contractsApiUrl');
		this.planApiUrl=this.element.nativeElement.getAttribute('planApiUrl');
